                                                                ...
                                                                <div class="form-body">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-8 offset-md-3">
                                                                            <button type="submit" name="load_daily_po" id="load_daily_po" class="btn btn-warning mr-1 mb-1 waves-effect waves-light">Load Daily Po</button>
                                                                            <button hidden id="load_daily_po_loader" class="btn btn-warning mb-1 waves-effect waves-light" type="button">
                                                            ...
                                                            <form class="form form-horizontal" id="load_weekly_po_form">
                                                                <div class="form-body">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-8 offset-md-3">
                                                                            <button type="submit" name="load_weekly_po" id="load_weekly_po" class="btn btn-warning mr-1 mb-1 waves-effect waves-light">Load Weekly Po</button>
                                                                            <button hidden id="load_weekly_po_loader" class="btn btn-warning mb-1 waves-effect waves-light" type="button">
                                                                                <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                                                                                Loading ...
                                                                            </button>
                                                                        </div>
                                                            ...
                                                            <form class="form form-horizontal" id="load_monthly_po_form">
                                                                <div class="form-body">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-8 offset-md-3">
                                                                            <button type="submit" name="load_monthly_po" id="load_monthly_po" class="btn btn-warning mr-1 mb-1 waves-effect waves-light">Load Monthly Po</button>
                                                                            <button hidden id="load_monthly_po_loader" class="btn btn-warning mb-1 waves-effect waves-light" type="button">
                                                                                <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                                                                                Loading ...
                                                                            </button>
                                                                        </div>
