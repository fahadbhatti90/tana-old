                    ...
                    <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                        <div class="card-content">
                            <div class="card-body text-center">
                                ...
                                <h1 class="font-large-2 my-1">419 - Session Expired!</h1>
                                <p class="px-2">
                                    Sorry, your Session has expire. Please Login and Try Again
                                </p>
                                <a class="btn btn-outline-danger btn-lg mt-1" href="{{ Route('login')  }}">Login Again</a>
                            </div>
                        </div>
                    </div>
                </div>
