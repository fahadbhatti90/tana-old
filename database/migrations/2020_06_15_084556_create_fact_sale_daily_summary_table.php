...
class CreateFactSaleDailySummaryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql2')->create('fact_sale_daily_summary', function (Blueprint $table) {
    ...
    {
        Schema::connection('mysql2')->dropIfExists('fact_sale_daily_summary');
    }
}
