...
class CreateMetadataFactDropshipTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('metadata_fact_dropship', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('metadata_fact_dropship');
    }
}
