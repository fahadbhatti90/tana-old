...
class CreateMetadataCoreScSaleTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('metadata_core_sc_sale', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('metadata_core_sc_sale');
    }
}
