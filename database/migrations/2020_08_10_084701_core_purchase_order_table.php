...
class CorePurchaseOrderTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('core_purchase_order', function (Blueprint $table) {
            ...
            $table->integer('datekey')->nullable();
    ...
    {
        Schema::dropIfExists('core_purchase_order');
    }
}
