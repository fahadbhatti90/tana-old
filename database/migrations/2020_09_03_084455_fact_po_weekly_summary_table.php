...
class FactPoWeeklySummaryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql2')->create('fact_po_weekly_summary', function (Blueprint $table) {
    ...
    {
        Schema::connection('mysql2')->dropIfExists('fact_po_weekly_summary');
    }
}
