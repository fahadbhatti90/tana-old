...
class StageSaleTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('stg_sale', function (Blueprint $table) {
            ...
            $table->index(['asin', 'subcategory'], 'idx_asin');
        });
    }
