...
class CreateFactInventoryWeeklySummaryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql2')->create('fact_inventory_weekly_summary', function (Blueprint $table) {
    ...
    {
        Schema::connection('mysql2')->dropIfExists('fact_inventory_weekly_summary');
    }
}
