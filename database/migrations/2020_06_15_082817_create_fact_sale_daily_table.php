...
class CreateFactSaleDailyTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql2')->create('fact_sale_daily', function (Blueprint $table) {
            ...
            $table->decimal('shipped_cogs', 20, 4)->nullable();
    ...
    {
        Schema::connection('mysql2')->dropIfExists('fact_sale_daily');
    }
}
