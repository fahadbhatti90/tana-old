...
class CreateFactSaleWeeklyTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql2')->create('fact_sale_weekly', function (Blueprint $table) {
    ...
    {
        Schema::connection('mysql2')->dropIfExists('fact_sale_weekly');
    }
}
