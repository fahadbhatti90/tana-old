document.addEventListener('DOMContentLoaded', function(e) {
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(data.errors)
                {
                    ...
                    html += '</div>';
                    if($('#form_action').val() == 'Add') {
                        $('#action_button').val('Add Operator');
                    }
                    if($('#form_action').val() == 'Edit') {
                        $('#action_button').val('Edit Operator');
                    }
    ...
    //View all Operator in datatabale
    ...
    $('#create_record').click(function(){
        ...
        $('#user_form_result').html('');
        $('#operator_modal_title').text('Add New Operator Information');
        $('#action_button').val('Add Operator');
        $('#form_action').val('Add');
    ...
    $(document).on('click', '.edit', function(){
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                $('#hidden_id').val(id);
                $('#operator_modal_title').text('Edit Operator Information');
                $('#action_button').val('Edit Operator');
    ...
    $(document).on('click', '.status', function(){
        ...
        $('#user_form_result').html('');
        $.ajax({
            url :base_url+"/operator/status/"+id,
            data:data,
            type: "PUT",
            dataType:"json",
            success:function(data){
    ...
    $(document).on('click', '.deleteUser', function () {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: "You want to delete this operator!",
            type: 'warning',
