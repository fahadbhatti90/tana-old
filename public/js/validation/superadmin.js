document.addEventListener('DOMContentLoaded', function(e) {
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(data.errors)
                {
                    ...
                    html += '</div>';
                    if($('#form_action').val() == 'Add') {
                        $('#action_button').val('Add Super Admin');
                    }
                    //set route and method for updating role specific
                    if($('#form_action').val() == 'Edit') {
                        $('#action_button').val('Edit Super Admin');
                    }
    ...
    $('#create_record').click(function(){
        ...
        $('#username').val("");
        $('#email').val("");
        $('#super_modal_title').text('Add New Super Admin Information');
        $('#action_button').val('Add Super Admin');
        $('#form_action').val('Add');
    ...
    $(document).on('click', '.edit', function(){
        ...
        $('#user_form_result').html("");
        $.ajax({
            url :base_url+"/superadmin/"+id+"/edit",
            dataType:"json",
            success:function(data)
            {
                ...
                $('#hidden_id').val(id);
                $('#super_modal_title').text('Edit Super Admin Information');
                $('#action_button').val('Edit Super Admin');
    ...
    $(document).on('click', '.status', function(){
        ...
        $('#user_form_result').html('');
        $.ajax({
            url :base_url+"/superadmin/status/"+id,
            data:data,
            type: "PUT",
            dataType:"json",
            success:function(data){
    ...
    $(document).on('click', '.deleteUser', function () {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: "You want to delete this super admin!",
            type: 'warning',
